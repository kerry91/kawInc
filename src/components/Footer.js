          ...
          <div class="order-first flex flex-wrap text-center md:text-left">
            <div class="w-full px-4 md:w-1/2 lg:w-1/4">
              ...
              <nav class="mb-10 list-none">
                ...
                <li>
                  <a href="/" class="text-gray-600 hover:text-gray-800"> Our Team</a>
                </li>
                <li>
                  <a href="/" class="text-gray-600 hover:text-gray-800">
                    Mission and Values
            ...
            <div class="w-full px-4 md:w-1/2 lg:w-1/4">
              ...
              <nav class="mb-10 list-none">
                ...
                <li>
                  <a href="/" class="text-gray-600 hover:text-gray-800"> FAQs</a>
                </li>
                <li>
                  <a href="/" class="text-gray-600 hover:text-gray-800">
                    {" "}
                ...
                <li>
                  <a href="/" class="text-gray-600 hover:text-gray-800">Case Studies </a>
                </li>
              </nav>
            </div>
            <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            ...
            <div class="w-full px-4 md:w-1/2 lg:w-1/4">
              ...
              <div class="flex flex-wrap items-end justify-center md:flex-nowrap md:justify-start lg:flex-wrap xl:flex-nowrap">
                ...
                <button class="inline-flex flex-shrink-0 rounded border-0 bg-indigo-500 px-6 py-2 text-white hover:bg-indigo-600 focus:outline-none lg:mt-2 xl:mt-0">
                  Button
                </button>
              </div>
